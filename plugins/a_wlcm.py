...
from ZenakuMusic import app
from ZenakuMusic.utils.database import get_assistant
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("ZenakuMusic/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype("ZenakuMusic/assets/font.ttf", size=110)
    welcome_font = ImageFont.truetype("ZenakuMusic/assets/font.ttf", size=60)
