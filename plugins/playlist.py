...
from ZenakuXMusic import Carbon, app
from ZenakuXMusic.utils.decorators.language import language, languageCB
from ZenakuXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from ZenakuXMusic.utils.pastebin import VIPBin
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from ZenakuXMusic import YouTube
