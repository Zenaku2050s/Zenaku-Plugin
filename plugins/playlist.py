...
from ZenakuMusic import Carbon, app
from ZenakuMusic.utils.decorators.language import language, languageCB
from ZenakuMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from ZenakuMusic.utils.pastebin import VIPBin
from ZenakuMusic.utils.stream.stream import stream
...
from ZenakuMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from ZenakuMusic import YouTube
